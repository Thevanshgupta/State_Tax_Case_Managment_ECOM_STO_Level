...
export const MOCK_CASES = [
  ...
  { id:10, caseNumber:'CASE/2024-25/0010', taxpayerName:'Sunrise Auto Parts',           gstin:'07AAACS9012J0Z2', circle:'Circle-V (Central)',  financialYear:'2024-25', cgst:37500,   sgst:37500,   cess:3750,   total:78750,    actionStage:null,     status:'Pending',    isFlagged:false, lastRemarks:'',                                assignedTo:7, assignedToName:'Kavitha R.',   createdAt:'20 Feb 2024', updatedAt:'20 Feb 2024' },
];

export const MOCK_HISTORY = {
  1: [
    { id:1,  userId:2, userName:'Rajesh Mehta', actionType:'created',       newValue:null,          remarks:'Scrutiny FY 2021-22',          createdAt:'10 Jan 2024' },
    { id:2,  userId:2, userName:'Rajesh Mehta', actionType:'assigned',      newValue:'Priya Sharma',remarks:'Circle-I assignment',           createdAt:'11 Jan 2024' },
    { id:3,  userId:3, userName:'Priya Sharma', actionType:'stage_updated', newValue:'DRC01',       remarks:'Notice issued to taxpayer',     createdAt:'15 Jan 2024' },
  ],
  2: [
    { id:4,  userId:2, userName:'Rajesh Mehta', actionType:'created',       newValue:null,          remarks:'ITC mismatch case',             createdAt:'20 Jan 2024' },
    { id:5,  userId:2, userName:'Rajesh Mehta', actionType:'assigned',      newValue:'Amit Singh',  remarks:'Circle-II assignment',          createdAt:'21 Jan 2024' },
    { id:6,  userId:4, userName:'Amit Singh',   actionType:'stage_updated', newValue:'ASMT10',      remarks:'Assessment notice issued',      createdAt:'28 Jan 2024' },
    { id:7,  userId:4, userName:'Amit Singh',   actionType:'flagged',       newValue:'Non-Compliance',remarks:'No response to notices',      createdAt:'05 Feb 2024' },
  ],
  3: [
    { id:8,  userId:2, userName:'Rajesh Mehta', actionType:'created',       newValue:null,          remarks:'Large taxpayer scrutiny',       createdAt:'05 Jan 2024' },
    { id:9,  userId:2, userName:'Rajesh Mehta', actionType:'assigned',      newValue:'Sunita Patel',remarks:'Circle-III assignment',         createdAt:'06 Jan 2024' },
    { id:10, userId:5, userName:'Sunita Patel', actionType:'stage_updated', newValue:'DRC01',       remarks:'SCN issued',                    createdAt:'15 Jan 2024' },
    { id:11, userId:5, userName:'Sunita Patel', actionType:'stage_updated', newValue:'DRC03',       remarks:'Partial payment received',      createdAt:'01 Feb 2024' },
  ],
  4: [
    { id:12, userId:2, userName:'Rajesh Mehta', actionType:'created',       newValue:null,          remarks:'Routine scrutiny',              createdAt:'01 Dec 2023' },
    { id:13, userId:2, userName:'Rajesh Mehta', actionType:'assigned',      newValue:'Deepak Rao',  remarks:'Circle-IV assignment',          createdAt:'02 Dec 2023' },
    { id:14, userId:6, userName:'Deepak Rao',   actionType:'stage_updated', newValue:'DRC07',       remarks:'Order passed',                  createdAt:'05 Jan 2024' },
    { id:15, userId:6, userName:'Deepak Rao',   actionType:'status_changed',newValue:'Completed',   remarks:'Case closed',                   createdAt:'05 Jan 2024' },
  ],
  8: [
    { id:16, userId:2, userName:'Rajesh Mehta', actionType:'created',       newValue:null,          remarks:'High value case',               createdAt:'01 Feb 2024' },
    { id:17, userId:2, userName:'Rajesh Mehta', actionType:'assigned',      newValue:'Sunita Patel',remarks:'Circle-III assignment',         createdAt:'01 Feb 2024' },
    { id:18, userId:5, userName:'Sunita Patel', actionType:'stage_updated', newValue:'DRC01',       remarks:'SCN issued',                    createdAt:'10 Feb 2024' },
    { id:19, userId:5, userName:'Sunita Patel', actionType:'stage_updated', newValue:'DRC06',       remarks:'Reply received, under review',  createdAt:'20 Feb 2024' },
    { id:20, userId:5, userName:'Sunita Patel', actionType:'flagged',       newValue:'High Value',  remarks:'Priority attention needed',     createdAt:'01 Mar 2024' },
  ],
};

export const MOCK_FLAGS = {
  2: [{ id:1, flaggedBy:4, flaggedByName:'Amit Singh',   reason:'Non-Compliance', remarks:'No response to notices',    isActive:true, flaggedAt:'05 Feb 2024' }],
